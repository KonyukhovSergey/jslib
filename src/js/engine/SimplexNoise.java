...
// added modification: double change to float
...
{ // Simplex noise in 2D, 3D and 4D
	...
	private static final float F2 = 0.5f * (FloatMath.sqrt(3.0f) - 1.0f);
	private static final float G2 = (3.0f - FloatMath.sqrt(3.0f)) / 6.0f;
	private static final float F3 = 1.0f / 3.0f;
	private static final float G3 = 1.0f / 6.0f;
	private static final float F4 = (FloatMath.sqrt(5.0f) - 1.0f) / 4.0f;
	private static final float G4 = (5.0f - FloatMath.sqrt(5.0f)) / 20.0f;
